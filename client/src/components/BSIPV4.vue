<template>
  <div class="ipv4">
    <div class="ip_label" :class="{'disabledAll':disabled, 'warning': (danger && isLegal && !disabled)}">
      <input class="ip_input" ref="one" @keyup.110="typeTab('one')" v-model="one" type="text" :disabled="disabled" @input="input('one')" @blur="ipBlur" />.
      <input class="ip_input" ref="two" @keyup.110="typeTab('two')" v-model="two" type="text" :disabled="disabled" @input="input('two')" @blur="ipBlur" />.
      <input class="ip_input" ref="three" @keyup.110="typeTab('three')" v-model="three" type="text" :disabled="disabled" @input="input('three')" @blur="ipBlur" />.
      <input class="ip_input" ref="four" @keyup.110="typeTab('four')" v-model="four" type="text" :disabled="disabled" @input="input('four')" @blur="ipBlur" />
    </div>
...
.ip_label {
  ...
  font-weight: normal;
  border-radius: 2px;
  border: 1px solid @icon-bg-color;
