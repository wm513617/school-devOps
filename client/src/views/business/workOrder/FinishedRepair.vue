...
export default {
  ...
  methods: {
    ...
    exportCSV() { // 导出
      ...
      this.elemIF.src = `${window.origin}/ops/workmanagement/export?status=1&seek=${this.seek}&limit=${this.limit}&page=${this.page}&repairsReason=${this.repairsReason}&startTime=${startTime}&endTime=${endTime}`
