<template>
  <div class="car-list">
    <div class="table-box">
      <Table :data="videoData" style="width: 100%" :height="tableHeight" v-loading="loading" @selection-change="changeChecked" highlight-current-row>
        <TableColumn type="selection" width="55"></TableColumn>
        <TableColumn label="序号" type="index" min-width="100" align="center"></TableColumn>
        <TableColumn label="设备名称" prop="name" min-width="300" show-overflow-tooltip></TableColumn>
        <TableColumn label="所属机构" prop="oid.name" min-width="200"></TableColumn>
        <TableColumn label="IP地址" prop="ip" min-width="200" align="center"></TableColumn>
        ...
        <TableColumn label="离线时长" prop="offTime" min-width="150" align="center">
          <template slot-scope="scope">
