  ...
  <div class="car-list">
    <div class="table-box">
      <Table size="small" :data="videoData" style="width: 100%" :height="tableHeight" v-loading="loading" highlight-current-row>
        ...
        <TableColumn label="服务器名称" prop="name" min-width="300" show-overflow-tooltip></TableColumn>
        <TableColumn label="设备IP" prop="ip" min-width="200" align="center"></TableColumn>
        ...
        <TableColumn label="CPU使用率" prop="CPURate" min-width="100" align="center"></TableColumn>
        <TableColumn label="内存使用率" prop="memoryRate" min-width="100" align="center"></TableColumn>
        <TableColumn label="网络接受" prop="networkGet" min-width="150" align="center"></TableColumn>
        <TableColumn label="网络发送" prop="networkPost" min-width="150" align="center"></TableColumn>
