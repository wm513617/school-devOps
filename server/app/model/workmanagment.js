/*
 * @Author: dfk
 * @Date: 2019-05-25 12:23:49
 * @Last Modified by: dfk
 * @Last Modified time: 2019-08-12 20:04:59
 * 工单管理模型
 */
...
module.exports = app => {
  ...
  let workmanagmentSchema = new Schema(
    {
      status: {
        // 维修状态 0：待维修  1：维修完成
        type: Number,
  ...
  return mongoose.model('WorkManagment', workmanagmentSchema)
}
